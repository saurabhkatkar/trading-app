    ...
    var chart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                borderColor: '#0b76b6',
                data: [279.86, 238.69, 185.16, 223.46, 241.61, 225.61, 240.87, 314.92, 329.94, 418.33, 650.57, 901.00],
            }]
        },
    ...
    var chart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                borderColor: '#F0B41A',
                data: [117.94, 130.60, 123.68, 133.96, 136.27, 137.86, 139.03, 143.37, 151.38, 157.70, 170.23, 178.59],
            }]
        },
        // Configuration options go here
        options: {
    ...
    var chart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                borderColor: '#fd9d24',
                fill: true,
                data: [189.95, 200.67, 175.07, 197.92, 213.04, 208.74, 223.97, 248.76, 267.25, 293.65, 309.51, 313.05],
            }]
        },
        // Configuration options go here
        options: {
